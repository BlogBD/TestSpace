...
<div class="container">
        ...
        <div style="margin:0 auto;margin-top:10px;width:950px;">
            ...
            <table class="table table-bordered">
                ...
                <tr class="active">
                    ...
                    <td width="30%">
                        <a href="${pageContext.request.contextPath}/ProductServlet?method=findProductById&pid=${item.product.pid}" target="_blank"> ${item.product.pname}</a>
                    </td>
                    <td width="20%">
    ...
    <div>
        <hr/>
        <form action="/OrderServlet" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
